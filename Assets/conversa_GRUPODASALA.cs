...
public class conversa_GRUPODASALA : MonoBehaviour
{

    public RectTransform rTransform;
    public GameObject btt_fotoNoah;
    ...
    public bool conversa_LEONARD_1;
    public bool conversa_LEONARD_2;
    public bool conversa_LEONARD_3;
    ...
    void Update()
    {
        ...
        if (conversa_LEONARD_1)
        {
            StartCoroutine(conversa_SAM_DIA1_depoisEscola());
            conversa_LEONARD_1 = false;
        }
        if (conversa_LEONARD_2)
        {
            StartCoroutine(conversa_SAM_DIA2_depoisEscola());
            conversa_LEONARD_2 = false;
        }
        if (conversa_LEONARD_3)
        {
            StartCoroutine(conversa_SAM_DIA3_depoisEscola());
            conversa_LEONARD_3 = false;
        }
    }
    ...
    {
        btt_fotoNoah.transform.parent = muzzle_Conversa.transform;
        btt_Voltar.enabled = false;
